            ...
            <div className='row'>
                <div className='col-12 col-lg-6 p-4 p-md-0 '>
                    <div className=' m-lg-5 border bg-white  p-2 p-md-5 my-2 box-shadow-custom'>
                        ...
                        <h4 className='fs-30 fw-400 heading-color mt-3 text-center'>Reset Your Password</h4>
                        <p className='sub-heading-color fs-13 fw-lighter text-center my-4 mx-5'>Here’s a tip: Use a combination of numbers, uppercase, lowercase and special characters</p>
                        <Formik
                        ...
                        >
                            {({ handleSubmit }) => (
                                <form onSubmit={handleSubmit} className='mx-4 mx-md-5'>
                                    <FormGroup>
                                    ...
                                    <div className="d-grid gap-3  mt-4 mb-5 pb-4">
                                        <Button type='submit' className=' fw-400 fs-15  btn-fill-color border-1 border-white py-2'  >
                                            {btnLoader ? (
                                                <div
