            ...
            <div className='row'>
                <div className='col-12 col-lg-6 p-4 p-md-0'>
                    <div className=' m-lg-5 border bg-white  p-2 p-md-5 my-2 box-shadow-custom'>
                        ...
                        <h4 className='fs-30 fw-400 heading-color mt-3 text-center'>Check Your Email</h4>
                        <p className='text-center my-3  sub-heading-color fs-13 fw-lighter'>We just sent a recovery code</p>
                        ...
                        <Form className='mx-5'>
                            ...
                            <div className=' text-center my-3 '>
                                <p className='fs-12 fw-500 text-color '>Didn't get a code? {timer !== 0 ? <span className='fw-700 text-muted'>Resend</span> : <Link to="" className='text-decoration-none fw-700 text-dark' onClick={() => resetTimer()}>Resend</Link>}  </p>
                            </div>
                            <div className={`d-grid gap-3 mb-5 pb-5 mt-4 `}>
                                <Button
                                    type='button'
                                    className=' fw-400 fs-15  btn-fill-color border-1 border-white py-2 mb-2'
                                    onClick={() => sendOTP()}
                                >
                                    {btnLoader ? (
                                        <div
                ...
                <div className='col-12 col-lg-6 d-none d-lg-block'>
                    <div className='position-relative d-flex justify-content-center align-items-end vh-100' >
                        <div className='text-center'>
                            <img src={otpBanner} alt='banner01' className='h-100 w-100' />
                        </div>
