...
const handleCheckout = async (selectedPlan) => {
  setIsMonthlyProcessing(selectedPlan === "year");
  setIsYearlyProcessing(selectedPlan === "lifetime");

  const amount = selectedPlan === "year" ? 39.99 : 89.99;
  ...
  try {
    ...
    // Redirect user to Stripe Checkout page URL returned by backend
      ...
      <div className="row bg-white box-shadow-custom rounded mb-5 ">
        <div className="col-12 col-lg-5 px-0 mx-0">
          <div className="px-lg-5 px-md-4 px-4 py-0 py-md-4 pb-4 ">
            <h5 className='fs-25 fw-400 ps-2'>{t("Yearly Plan")}</h5>
            <h3 className='fw-600 fs-35 ps-2 align-item-center d-flex'>$39.99 <span className="fs-18 fw-500 text-color pt-1 mt-2 ps-1"> / {t("per year")}</span></h3>
            <div className="ps-2">
        ...
        <div className="col-12 col-lg-7 px-0 mx-0 mt-3 mt-lg-0 subscriptionBgImg rounded-4">
          <div className="px-lg-5 px-md-4 px-3 pt-3 pt-md-5 pb-0 mt-5 mt-md-0">
            <h5 className="text-light ps-3 pt-md-5 fs-25 fw-400">{t("Life Time Plan")} <span className="fs-6 fw-500 ps-4 dark-purple">Save 20%</span></h5>
            <h3 className="text-light ps-3 fw-600 fs-35 align-item-center d-flex ">$89.99 <span className="fs-18 fw-500 pt-1 mt-2 ps-1">/ {t("life time access")}</span></h3>
