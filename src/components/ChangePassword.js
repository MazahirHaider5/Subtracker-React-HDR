  ...
  const handelSendOTP = async () => {
    try {
      ...
      if (result.status === 200) {
        setBtnLoader(false)
        setViewStatus("otp")
        showToast(result?.data?.message, "success", "top-start");
                  ...
                  >
                    {({ handleSubmit, setFieldValue, values }) => (
                      <Form className="text-start" onSubmit={handleSubmit}>
                        <FormGroup>
                          <Label htmlFor="newPassword" className="text-color fs-14 fw-500">New Password</Label>
                          <div className="d-flex align-items-center position-relative border rounded-3">
                            <Field
                              name="newPassword"
                        ...
                        <FormGroup>
                          <Label htmlFor="confirmPassword" className="text-color fs-14 fw-500">Confirm Password</Label>
                          <div className="d-flex align-items-center position-relative border rounded-3">
                            <Field
